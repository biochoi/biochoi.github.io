...
<div markdown="0" style="display: flex; align-items: center; gap: 1.5rem; margin-bottom: 2rem;"><img src="/assets/img/Logo.png" alt="BioMol Lab Logo" style="width: 230px; height: auto; flex-shrink: 0;"><div style="font-size: 1.05rem; color: var(--global-text-color-light); line-height: 1.5; flex: 1; min-width: 0;">Department of Chemical Engineering and Applied Chemistry<br>Chungnam National University</div></div>
